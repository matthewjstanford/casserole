...
default['cassandra']['config']['max_hint_window_in_ms'] = 10800000 # 3 hours
...
default['cassandra']['config']['authenticator'] = 'AllowAllAuthenticator'
...
default['cassandra']['config']['authorizer'] = 'AllowAllAuthorizer'
...
default['cassandra']['config']['key_cache_size_in_mb'] = nil
...
default['cassandra']['config']['key_cache_save_period'] = 14400

# Number of keys from the key cache to save
# Disabled by default, meaning all keys are going to be saved
# key_cache_keys_to_save: 100
default['cassandra']['config']['key_cache_keys_to_save'] = nil
...
default['cassandra']['config']['row_cache_save_period'] = 0
...
default['cassandra']['config']['commitlog_periodic_queue_size'] = nil
...
default['cassandra']['config']['trickle_fsync_interval_in_kb'] = 10240
...
default['cassandra']['config']['internode_authenticator'] = 'org.apache.cassandra.auth.AllowAllInternodeAuthenticator'
...
default['cassandra']['config']['rpc_min_threads'] = nil
...
# /proc/sys/net/ipv4/tcp_wmem
# and: man tcp
default['cassandra']['config']['internode_send_buff_size_in_bytes'] = nil
default['cassandra']['config']['internode_recv_buff_size_in_bytes'] = nil
...
default['cassandra']['config']['request_timeout_in_ms'] = 10000
...
default['cassandra']['config']['streaming_socket_timeout_in_ms'] = 0

# phi value that must be reached for a host to be marked down.
# most users should never need to adjust this.
# phi_convict_threshold: 8
default['cassandra']['config']['phi_convict_threshold'] = nil
...
default['cassandra']['config']['endpoint_snitch'] = 'SimpleSnitch'
...
default['cassandra']['config']['request_scheduler_id'] = 'keyspace'
...
#
default['cassandra']['config']['server_encryption_options']['internode_encryption'] = 'none'
...
default['cassandra']['config']['internode_compression'] = 'all'
